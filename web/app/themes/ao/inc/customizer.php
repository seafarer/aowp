<?php
/**
 * Adventure Outdoors Theme Theme Customizer
 *
...
function ao_customize_preview_js() {
	wp_enqueue_script( 'ao-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), _S_VERSION, true );
}
